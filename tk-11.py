...
btn_2 = Button(root, text="0,1", bg="yellow")
btn_3 = Button(root, text="0,2", bg="blue")

btn_4 = Button(root, text="1,0", bg="red")
btn_5 = Button(root, text="1,1", bg="purple")
btn_6 = Button(root, text="1,2", bg="orange")

btn_7 = Button(root, text="2,0", bg="pink")
btn_8 = Button(root, text="2,1", bg="cyan")
btn_9 = Button(root, text="2,2", bg="gray")

btn_10 = Button(root, text="3,0", bg="brown")
btn_11 = Button(root, text="3,1", bg="lime")
btn_12 = Button(root, text="3,2", bg="teal")
